...
<main class="commission-page-container">
    <div class="commission-form-wrapper">
        ...
        <form id="commissionForm" action="${pageContext.request.contextPath}/RichiestaCommissioneServlet" method="POST" enctype="multipart/form-data" onsubmit="return validaCommissione()" novalidate style="display: flex; flex-direction: column; flex: 1; overflow: hidden;">
            ...
            <div class="commission-form-scroll-area">
                ...
                <div class="form-step" id="step-2">
                    <fieldset class="form-section">
                        ...
                        <div class="form-group file-upload-wrapper">
                            <label class="section-subtitle"><i class="fa-solid fa-file-arrow-up"></i> Allega file di riferimento (Opzionale)</label>
                            
                            <label for="fileRiferimento" class="file-dropzone">
                                <i class="fa-solid fa-cloud-arrow-up" style="font-size: 1.5rem; color: #0f0326; margin-bottom: 8px;"></i>
                                <span>Clicca o trascina i file qui</span>
                                <small>Formati: .stl, .obj, .blend, .png, .jpg (Max 20MB)</small>
                            </label>
                            ...
                            <div class="split-options">
                                ...
                                <div class="option-box">
                                    ...
                                    <div id="containerPostProduzione" style="display: none; margin-top: 10px;">
                                        <select name="tipo_postproduzione">
            ...
            </div> <div class="form-footer-actions">
                <div class="step-actions-group" id="actions-step-1" style="display: flex; justify-content: flex-end;">
                    <button type="button" class="btn-primary auth-btn" onclick="nextStep(2)">Avanti</button>
                </div>
                
                <div class="step-actions-group" id="actions-step-2" style="display: none; justify-content: space-between;">
                ...
                <div class="step-actions-group" id="actions-step-3" style="display: none; justify-content: space-between;">
...
<script>
    ...
    function updateActions(stepNumber) {
        ...
        const activeGroup = document.getElementById('actions-step-' + stepNumber);
        if(activeGroup) {
